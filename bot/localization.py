...
STRINGS = {
    "en": {
        ...
        "message_received": "Message received: {text}", # Example, not used by current commands
        "bot_started": "Bot started...",
        "login_failed": "Login failed. Please try again later. Details: {error_details}",
        "login_data_mismatch_error": "There was an issue processing your login data. Please try again.", # Not currently used, but good to have
    ...
    "fa": {
        ...
        "message_received": "پیام دریافت شد: {text}", # مثال، توسط دستورات فعلی استفاده نشده
        "bot_started": "بات شروع به کار کرد...",
        "login_failed": "ورود ناموفق بود. لطفا بعدا تلاش کنید. جزئیات: {error_details}",
        "login_data_mismatch_error": "در پردازش اطلاعات ورود شما مشکلی پیش آمد. لطفا دوباره تلاش کنید.", # در حال حاضر استفاده نشده
